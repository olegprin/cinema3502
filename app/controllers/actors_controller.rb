class ActorsController < ApplicationController
  ...
  # GET /actors.json
  def index
    @actors = Actor.paginate(:page => params[:page], :per_page => 8)
  
    #@actors = Actor.search(params[:search]).paginate(:page => params[:page], :per_page => 8)
  end
  ...
  private
    ...
    def actor_params
      params.require(:actor).permit(:uploaded_photo,:title, :description)
    end
end
